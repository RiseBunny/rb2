...
exports.run = async (client, message, args) => {
  ...
  const hedefRol = db.fetch(`erkekrol_${message.guild.id}`);
  ...
  const ok = new EmbedBuilder()
    .setAuthor({ name: client.user.username, iconURL: client.user.displayAvatarURL() })
    .setTitle(t(lang, "kayitSistem.erkekKayit"))
    .setColor(0x36393F)
...
exports.conf = { enabled: true, guildOnly: true, aliases: ['e'], permLevel: 0, kategori: "kayit" };
exports.help = { name: "erkek", description: "erkek olarak kayıt eder", usage: "erkek @kullanıcı isim yaş" };
